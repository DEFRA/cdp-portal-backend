...
public static class LegacyStatusesEndpoint
{
    public static void MapLegacyStatusesEndpoint(this IEndpointRouteBuilder app)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        await entitiesService.Create(Entity.from(status), cancellationToken);
        return Results.Ok();
    }
