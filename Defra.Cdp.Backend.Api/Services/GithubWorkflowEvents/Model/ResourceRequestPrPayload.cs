...
public record ResourceRequestPrPayload
{
    ...
    [JsonPropertyName("workflowRunId")] public required string WorkflowRunId { get; init; }
    [JsonPropertyName("workflowRunUrl")] public required string WorkflowRunUrl { get; init; }
    ...
    [JsonPropertyName("prUrl")] public required string PrUrl { get; init; }
