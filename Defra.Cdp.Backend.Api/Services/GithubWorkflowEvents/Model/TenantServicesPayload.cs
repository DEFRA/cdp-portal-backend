...
public record Service
{
    ...
    public record SqsSubscription
    {
        ...
        [JsonPropertyName("filter_enabled"), 
         JsonConverter(typeof(FlexibleBoolConverter))] public bool? FilterEnabled { get; init; }
    ...
    public record SqsQueue
    {
        ...
        [JsonPropertyName("fifo_queue"), 
         JsonConverter(typeof(FlexibleBoolConverter))] public bool FifoQueue { get; init; } = false;
        
        [JsonPropertyName("content_based_deduplication"), 
         JsonConverter(typeof(FlexibleBoolConverter))] public bool? ContentBasedDeduplication { get; init; }
    ...
    public record SnsTopic
    {
        ...
        [JsonPropertyName("fifo_topic"), 
         JsonConverter(typeof(FlexibleBoolConverter))] public bool? FifoTopic { get; init; } = false;
        
        [JsonPropertyName("content_based_deduplication"), 
         JsonConverter(typeof(FlexibleBoolConverter))] public bool? ContentBasedDeduplication { get; init; } = false;
    }
